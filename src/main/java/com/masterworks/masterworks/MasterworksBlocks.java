...
public class MasterworksBlocks {
    static final DeferredRegister.Blocks REGISTRAR = DeferredRegister.createBlocks(MasterworksMod.ID);

    public static void register(IEventBus bus) {
        REGISTRAR.register(bus);
    }

    static <T extends Block> DeferredBlock<T> register(String name, Function<Block.Properties, T> factory) {
