...
public record Composition(TierResourceLocation tier, List<PartDefinition> parts,
        Map<Stat, Expression> properties) {

    public static final Codec<Composition> CODEC = RecordCodecBuilder.create(instance -> instance
            .group(TierResourceLocation.CODEC.fieldOf("tier").forGetter(Composition::tier),
