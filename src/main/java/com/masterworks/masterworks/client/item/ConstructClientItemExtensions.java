...
public class ConstructClientItemExtensions implements IClientItemExtensions, Closeable {
    ...
    public @Nullable ResourceLocation getArmorTexture(
        ...
        RenderEquipmentProperty property = construct
                .properties(RoleReferenceLocation.ITEM)
                .get(MasterworksPropertyTypes.RENDER_EQUIPMENT.get())
                .orElse(null);
        if (property == null) {
        ...
        NativeImage image = property.render(construct.components())
        ...
        Minecraft.getInstance().getTextureManager().register(location, new DynamicTexture(() -> label, image));
    ...
    private static ResourceLocation qualify(String label) {
        return ResourceLocation.fromNamespaceAndPath(
                MasterworksMod.ID, "assets/" + MasterworksMod.ID + "/textures/generated/" + label + ".png");
    }
