...
public record CompositionReferenceLocation(ResourceLocation value)
    ...
    public static final Codec<CompositionReferenceLocation> CODEC = ResourceLocation.CODEC
            .xmap(CompositionReferenceLocation::new, CompositionReferenceLocation::value);

    public static final StreamCodec<ByteBuf, CompositionReferenceLocation> STREAM_CODEC =
            ResourceLocation.STREAM_CODEC.map(CompositionReferenceLocation::new,
                    CompositionReferenceLocation::value);
    ...
    public static CompositionReferenceLocation fromNamespaceAndPath(String namespace, String path) {
        return new CompositionReferenceLocation(
