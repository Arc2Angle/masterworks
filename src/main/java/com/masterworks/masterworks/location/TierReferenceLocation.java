...
public record TierReferenceLocation(ResourceLocation unqualified) implements TextureReferenceLocation {

    public static final Codec<TierReferenceLocation> CODEC =
            ResourceLocation.CODEC.xmap(TierReferenceLocation::new, TierReferenceLocation::unqualified);

    public static final StreamCodec<ByteBuf, TierReferenceLocation> STREAM_CODEC =
            ResourceLocation.STREAM_CODEC.map(TierReferenceLocation::new, TierReferenceLocation::unqualified);
