...
public record PaletteReferenceLocation(ResourceLocation unqualified) implements TextureReferenceLocation {

    public static final Codec<PaletteReferenceLocation> CODEC =
            ResourceLocation.CODEC.xmap(PaletteReferenceLocation::new, PaletteReferenceLocation::unqualified);

    public static final StreamCodec<ByteBuf, PaletteReferenceLocation> STREAM_CODEC =
            ResourceLocation.STREAM_CODEC.map(PaletteReferenceLocation::new, PaletteReferenceLocation::unqualified);
